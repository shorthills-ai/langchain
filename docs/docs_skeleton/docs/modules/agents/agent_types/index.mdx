...
the function should be called and respond with the inputs that should be passed to the function.
...
It uses the ReAct framework to decide which tool to use and uses memory to remember previous conversation interactions.
